public interface List<T> {
    ...
    Position<T> insertBefore(Position<T> p, T t) throws InvalidPositionException;
    ...
    // if there's no neighbor, return null???
    ...
    T get(Position<T> p) throws InvalidPositionException;
    void put(Position<T> p, T t) throws InvalidPositionException;
}
