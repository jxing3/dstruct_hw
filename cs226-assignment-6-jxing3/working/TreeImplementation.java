...
public class TreeImplementation<T> implements Tree<T> {
    ...
    */
    ...
    /**
        ...
        @throws InvalidPositionException If p not valid.
    */
    public Position<T> insertChild(Position<T> p, T t) throws InvalidPositionException {

        Node<T> p1 = this.convert(p);
    ...
    */
    public T removeAt(Position<T> p) throws InvalidPositionException, RemovalException {
